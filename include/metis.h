...
typedef enum {
  ...
  METIS_OPTION_COARSENTO,
  METIS_OPTION_LLSWITCH,
  METIS_OPTION_SMALLGR,
  METIS_OPTION_NCOARSENGR,
  METIS_OPTION_NRUNSMLNDL1,
  METIS_OPTION_MINNEDGES,
  METIS_OPTION_MINNVTXS
} moptions_et;
...
typedef enum {
  ...
  METIS_DBG_LOW_LEVEL     = 4096,    /*!< Show info related to low level reordering */
} mdbglvl_et;
