 ...
 * Modified to obfuscate names using the 'libmetis__' prefix.
 *
 */
...
#define CreateMyGraph                   libmetis__CreateMyGraph
#define CreateMyGraphWspace             libmetis__CreateMyGraphWspace
#define FreeMyGraph                     libmetis__FreeMyGraph
...
#define AMDOrder			libmetis__AMDOrder
#define RCMOrder			libmetis__RCMOrder
#define EmptyOrder			libmetis__EmptyOrder
