...
void InitTimers(ctrl_t* ctrl)
{
  ...
  //todo ����������� �������� �� ���������� ������
	/*ctrl->CoarsenCount = 0;
	ctrl->MatchCount = 0;
	ctrl->ContractCount = 0;
	ctrl->InitPartCount = 0;
	ctrl->UncoarsenCount = 0;
	ctrl->RefCount = 0;
	ctrl->ProjectCount = 0;
	ctrl->SplitCount = 0;
	ctrl->LowLevelCount = 0;*/
}
...
void PrintTimers(ctrl_t *ctrl)
{
  ...
  printf("\n Lowlevel: \t\t %7.3"PRREAL"(%d)", gk_getwctimer(ctrl->LowLevelTmr), ctrl->LowLevelCount);
/*
