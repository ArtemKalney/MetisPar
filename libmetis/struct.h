...
typedef struct ctrl_t {
  ...
  lowlevel_et ltype;		/* The type of low level reordering */
...
idx_t llswitch;                /*-# ������ ���.����� ��� �������� � low level reordering*/
  ...
  double TotalTmr, InitPartTmr, MatchTmr, ContractTmr, CoarsenTmr, UncoarsenTmr,
        RefTmr, ProjectTmr, SplitTmr, Aux1Tmr, Aux2Tmr, Aux3Tmr, LowLevelTmr;

/* Various Counters */
    int InitPartCount, MatchCount, ContractCount, CoarsenCount, UncoarsenCount,
        RefCount, ProjectCount, SplitCount, LowLevelCount;
...
typedef struct my_graph_t {
    idx_t n, m, m_max;	/* The # of vertices and edges in the graph */
    idx_t* nx, * adj, * first, * prev, * inv_first, * counts;
} my_graph_t;
